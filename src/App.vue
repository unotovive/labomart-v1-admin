<template>
  <div id="app">
    <div class="tab">
      <svg aria-hidden="true" data-prefix="fas" data-icon="box-open" class="svg-inline--fa fa-box-open fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" width="100px">
        <defs>
          <linearGradient id="g">
            <stop offset="0" stop-color="#11FFBD"/>
            <stop offset="1" stop-color="#AAFFA9"/>
          </linearGradient>
        </defs>
